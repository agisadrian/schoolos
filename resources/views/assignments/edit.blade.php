...
@section('title', 'Edit Tugas - ' . $class->name)
                    ...
                    >
                        ...
                        <div class="mb-4">
                            ...
                            >
                                ...
                                @foreach($subjects as $subject)
                                    ...
                                    <option
                                        value="{{ $subject->id }}"
                                        {{ old('subject_id', $assignment->subject_id) == $subject->id
                                            ? 'selected'
                                            : '' }}
                                    >
                                        {{ $subject->name }}
                        ...
                        <div class="mb-4">
                            ...
                            <label
                                ...
                                class="form-label fw-semibold"
                            >
                                {{ $assignment->file_name ? 'Ganti File (opsional)' : 'Lampiran File (opsional)' }}
                            </label>
